...
import { DURATION_OPTIONS, GENDER_OPTIONS } from './serviceWizardConstants';
import {
 ...
 *
 * Single-service form used to edit an existing service. Bulk creation lives in
 * VendorAddServiceWizard's batch step.
 */
const VendorConfigureService = ({
  ...
  const title = editingService ? 'Configure service' : 'Add new service';
  const primaryActionLabel = editingService ? 'Update Service' : 'Save Service';
