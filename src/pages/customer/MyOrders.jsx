          ...
          <div className="space-y-3">
            {orders.map((order) => (
              <div key={order.id} className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden transition-all hover:shadow-md">
                {/* Order Header */}
                <div className="bg-gray-50/50 px-3 py-2 border-b border-gray-100 grid grid-cols-3 md:grid-cols-4 gap-2 items-center">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-gray-900">₹{order.total_amount}</p>
                  </div>
