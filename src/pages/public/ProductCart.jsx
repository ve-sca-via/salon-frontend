...
function ProductCartItem({ item, onIncrement, onDecrement, onRemove }) {
  return (
    <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
      <div className="flex items-center gap-3">
        {/* Product Image */}
        <div className="w-14 h-14 bg-gray-50 rounded-lg overflow-hidden flex-shrink-0 border border-gray-100 p-1">
          <OptimizedImage
        ...
        <div className="flex-1 min-w-0">
          <h4 className="font-bold text-gray-800 text-sm mb-0.5 truncate group-hover:text-accent-orange transition-colors">
            {item.name}
          </h4>
          <p className="text-accent-orange font-bold text-base">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center bg-gray-50 rounded-md p-0.5 border border-gray-200">
            <button
              ...
              className="p-0.5 hover:bg-white rounded transition-all text-gray-500 hover:text-accent-orange"
            >
      ...
      <main className="flex-grow max-w-2xl mx-auto px-4 py-6 w-full">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button 
              onClick={() => navigate(-1)}
              className="p-1.5 hover:bg-white rounded-full transition-colors text-gray-600"
            >
              <FiArrowLeft className="w-5 h-5" />
            </button>
            <h1 className="text-2xl font-bold text-gray-900">Your Product Cart</h1>
          </div>
          {cart?.items?.length > 0 && (
            <button
        ...
        {isLoading ? (
          ...
          <div className="bg-red-50 p-3 rounded-xl border border-red-100 text-red-600 text-center text-sm">
            ...
            <div className="w-full">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                ...
                <button
                  ...
                  className="w-full bg-accent-orange hover:bg-accent-orange/90 text-white font-bold py-3 rounded-lg transition-all shadow-md text-sm"
                >
                  Proceed to Checkout
                </button>
              </div>
