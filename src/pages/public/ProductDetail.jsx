    ...
    return (
      <div className="min-h-screen bg-bg-secondary flex flex-col">
        ...
        <div className="flex-grow container mx-auto px-4 py-16 text-center">
          ...
          <button 
            onClick={() => navigate('/')}
            className="inline-flex items-center text-accent-orange font-semibold hover:underline"
          >
          ...
          <div className="bg-primary-white rounded-2xl shadow-sm p-6 lg:p-10 flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-1/2 flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                <button 
                  className="flex-1 flex justify-center items-center gap-2 border-2 border-accent-orange text-accent-orange font-semibold py-3 px-6 rounded-xl hover:bg-orange-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button 
                  className="flex-1 flex justify-center items-center gap-2 bg-accent-orange text-white font-semibold py-3 px-6 rounded-xl hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
