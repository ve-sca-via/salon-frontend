...
const Careers = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.highest_qualification.trim()) newErrors.highest_qualification = 'Qualification is required';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-neutral-black mb-2">
                      Age <span className="text-accent-orange">*</span>
                    </label>
                    <input
                      type="number"
                      name="age"
                      ...
                      max="70"
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent-orange focus:border-transparent ${
                        errors.age ? 'border-red-500' : 'border-neutral-gray-600'
                      }`}
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-neutral-black mb-2">
                      Highest Qualification <span className="text-accent-orange">*</span>
                    </label>
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent-orange focus:border-transparent ${
                        errors.highest_qualification ? 'border-red-500' : 'border-neutral-gray-600'
                      }`}
                    >
                    ...
                    {errors.highest_qualification && <p className="text-red-600 text-sm mt-1">{errors.highest_qualification}</p>}
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent-orange focus:border-transparent ${
                        errors.permanent_address ? 'border-red-500' : 'border-neutral-gray-600'
                      }`}
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-semibold text-neutral-black mb-2">
                      Current Address <span className="text-accent-orange">*</span>
                    </label>
                    <textarea
                      ...
                      rows={2}
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent-orange focus:border-transparent ${
                        errors.current_address ? 'border-red-500' : 'border-neutral-gray-600'
                      }`}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <FileUpload
                    ...
                    error={errors.resume}
                    helpText="Upload your latest resume (PDF, Word)"
                  />
              ...
              <div>
                ...
                <div>
                  <label className="block text-sm font-semibold text-neutral-black mb-2">
                    Cover Letter <span className="text-accent-orange">*</span>
                  </label>
                  <textarea
                    name="cover_letter"
                    ...
                    rows={4}
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent-orange focus:border-transparent ${
                      errors.cover_letter ? 'border-red-500' : 'border-neutral-gray-600'
                    }`}
